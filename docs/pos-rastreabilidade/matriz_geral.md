...
| Elo(Backward-from) | Categoria | Técnica | ID/Requisito                                                                                                    | Cenário | Casos de Uso | ID/História de Usuário | Elo(Forward-from) |
|--------------------|-----------|---------|-----------------------------------------------------------------------------------------------------------------|---------|--------------|------------------------|-------------------|
...
|                    |           |         | RF27/O usuário deve poder ter uma agenda para visualizar afazeres do dia.	                                      |         |              |                        |                   |
|                    |           |         | RF28/O usuário deve poder criar Formulas matemáticas.	                                                          |         |              |                        |                   |
|                    |           |         | RF29/O usuário deve poder criar seu próprio quadro kanban personalizado.	                                       |         |              |                        |                   |
|                    |           |         | RF30/O usuário pode escrever blocos de código.	                                                                 |         |              |                        |                   |
|                    |           |         | RF31/O usuário deve ser informado da situação do clima em sua região.	                                          |         |              |                        |                   |
|                    |           |         | RF32/O usuário deve conseguir criar uma conta	                                                                  |         |              |                        |                   |
...
|                    |           |         | RNF3/O aplicativo deve ser cross-plataform	                                |         |              |                        |                   |
